...
function login() {
    ...
    return location.href = "http://sso.zt.com/page/login";

}
function regist() {
    // return location.href = "http://localhost:8084/page/register";
    return location.href = "http://sso.zt.com/page/register";
}
...
function search(a) {
    ...
    var b = "http://www.zt.com/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
