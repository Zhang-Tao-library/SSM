...
$.extend(jdModelCallCenter, {autoLocation: function(a) {
    ...
    if (a && $.browser.msie && 6 == $.browser.version) {
        ...
        }).bind("mouseleave", function() {rest.taotao.com/rest/itemcat/list
...
var category = {OBJ: $("#_JD_ALLSORT"),
		...
		URL_Serv: "http://rest.zt.com/rest/itemcat/lists?callback=category.getDataService",
       ...
       /* var a, b = {}, c = $("#categorys-2013");
    	...
    	//直接使用ajax请求json数据
    	// $.getJSON(this.URL_Serv, function(json){         category.getDataService(json);
   //	});
